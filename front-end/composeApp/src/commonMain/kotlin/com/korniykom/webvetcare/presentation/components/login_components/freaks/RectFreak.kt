...
private fun changeFreakFloatValues(state: FreaksLookState, freakInfo: RectFreakInfo): RectFreakInfo = when (state) {
    FreaksLookState.EMAIL_FIELD -> freakInfo.copy(
        bottomLeftPointX = freakInfo.bottomLeftPointX + 10, bottomLeftPointY = freakInfo.bottomLeftPointY + 20,
    ...
    FreaksLookState.PASSWORD_FIELD_HIDDEN -> freakInfo.copy(
        bottomLeftPointX = freakInfo.bottomLeftPointX + 10, bottomLeftPointY = freakInfo.bottomLeftPointY + 25,
        bottomRightPointX = freakInfo.bottomRightPointX + 10, bottomRightPointY = freakInfo.bottomRightPointY + 35,
        outerLeftEyePositionX = freakInfo.outerLeftEyePositionX + 25, outerLeftEyePositionY = freakInfo.outerLeftEyePositionY + 15f ,
        outerRightEyePositionX = freakInfo.outerRightEyePositionX + 25, outerRightEyePositionY = freakInfo.outerRightEyePositionY + 15f,
        innerLeftEyePositionX = freakInfo.innerLeftEyePositionX + 26, innerLeftEyePositionY = freakInfo.innerLeftEyePositionY + 17,
        innerRightEyePositionX = freakInfo.innerRightEyePositionX + 26, innerRightEyePositionY = freakInfo.innerRightEyePositionY + 17,
    )

    FreaksLookState.PASSWORD_FIELD_VISIBLE -> freakInfo.copy(
        bottomLeftPointX = freakInfo.bottomLeftPointX - 20, bottomLeftPointY = freakInfo.bottomLeftPointY - 30,
        bottomRightPointX = freakInfo.bottomRightPointX - 30, bottomRightPointY = freakInfo.bottomRightPointY - 30,
        outerLeftEyePositionX = freakInfo.outerLeftEyePositionX - 26, outerLeftEyePositionY = freakInfo.outerLeftEyePositionY - 15f ,
        outerRightEyePositionX = freakInfo.outerRightEyePositionX - 26, outerRightEyePositionY = freakInfo.outerRightEyePositionY - 15f,
        innerLeftEyePositionX = freakInfo.innerLeftEyePositionX - 28, innerLeftEyePositionY = freakInfo.innerLeftEyePositionY -17.5f,
        innerRightEyePositionX = freakInfo.innerRightEyePositionX - 28, innerRightEyePositionY = freakInfo.innerRightEyePositionY- 17.5f,
    )
